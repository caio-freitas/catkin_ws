...
FONT = pygame.font.Font("STIX-Bold.otf", 18)
...
def main():
    ...
    upButton = Button('media/upbutton.png', 'media/upbuttonpressed.png', ((leftControllerCenterX), (leftControllerCenterY - shift)), 150, upMSG)
    downButton = Button('media/downbutton.png', 'media/downbuttonpressed.png', ((leftControllerCenterX), (leftControllerCenterY + shift)), 150, downMSG)
    rightButton = Button('media/rightbutton.png', 'media/rightbuttonpressed.png', ((rightControllerCenterX + shift), (rightControllerCenterY)), 150, rightMSG)
    leftButton = Button('media/leftbutton.png', 'media/leftbuttonpressed.png', ((rightControllerCenterX - shift), (rightControllerCenterY)), 150, leftMSG)
    frontButton = Button('media/upbutton.png', 'media/upbuttonpressed.png', ((rightControllerCenterX), (rightControllerCenterY - shift)), 150, frontMSG)
    backButton = Button('media/downbutton.png', 'media/downbuttonpressed.png', ((rightControllerCenterX), (rightControllerCenterY + shift)), 150, backMSG)
    yawRightButton = Button('media/rightbutton.png', 'media/rightbuttonpressed.png', ((leftControllerCenterX + shift), (leftControllerCenterY)), 150, yawRightMSG)
    yawLeftButton = Button('media/leftbutton.png', 'media/leftbuttonpressed.png', ((leftControllerCenterX - shift), (leftControllerCenterY)), 150, yawLeftMSG)
    button_list = {upButton, downButton, rightButton, leftButton, frontButton, backButton, yawRightButton, yawLeftButton}

    frame = VisualElement('media/frame.png', (((display_width/2)-((display_height+shift)/2)),0))
