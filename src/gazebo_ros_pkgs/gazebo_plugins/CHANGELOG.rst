...
* Fix gazebo8 warnings part 3: more ign-math in plugins (kinetic-devel) (`#632 <https://github.com/ros-simulation/gazebo_ros_pkgs/issues/632>`_)
* Fix gazebo8 warnings part 2: replace private member gazebo::math types with ignition (kinetic-devel) (`#630 <https://github.com/ros-simulation/gazebo_ros_pkgs/issues/630>`_)
...
* Contributors: Dave Coleman, Jose Luis Rivero, Kei Okada, caio Walter, Yuki Furuta
